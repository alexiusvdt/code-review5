...
describe('Age', () => {
  ...
  test('should return positive numbers for users who are older than the average age', () => {
    age.earthAge = 90
    expect(age.difference()).toEqual(`You're older than the earth average by 10 years.`)
  });
